...
# running MaryClare's suggestion for RATE, but this time running g through the RATE function
# September 7, 2021
...
#Gaussian kernel can be specified as k(u,v) = exp{||uÃ¢ÂÂv||^2/2h^2}.
