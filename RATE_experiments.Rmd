---
title: "RATE Experiments Notebook"
author: "Emily Winn"
output: pdf_document
---
...
```{r}
load('Y:/scratch/data/RATE_MA_same_2.Rdata')
load('Y:/scratch/data/RATE_MA_diff_2.Rdata')
load('Y:/scratch/data/RATE_MA_overlap_2.Rdata')
#load('Y:/scratch/data/RATE_MA_interact.data')
```
