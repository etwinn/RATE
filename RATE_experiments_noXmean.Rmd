...
```{r, echo = FALSE}
load('Y:/data/ewinn/RATEMC/RateSimExpReplicate/RATE_MA_same_ESAfast.Rdata')
load('Y:/data/ewinn/RATEMC/RateSimExpReplicate/RATE_MA_diff_ESAfast.Rdata')
load('Y:/data/ewinn/RATEMC/RateSimExpReplicate/RATE_interaction_ESAfast.Rdata')
load('Y:/data/ewinn/RATEMC/RateSimExpReplicate/RATE_MA_overlap_ESAfast.Rdata')
```
...
OGsame <- ggplot() + 
  ...
  ggtitle("RATE OG Effect Sizes (same)")+
  ylim(0,0.9)
...
OGdiff <- ggplot() +
  ...
  scale_x_discrete(limits=snps) + 
  theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5), legend.position="right") +
  ggtitle("RATE OG Effect Sizes (diff)")+
  ylim(0,0.9)
...
OGoverlap <- ggplot() + 
    ...
    scale_x_discrete(limits=snps) + 
    theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5), legend.position="right") +
    ggtitle("RATE OG Effect Sizes (overlap)")+
    ylim(0,0.9)
...
OGinteract <- ggplot() + 
    ...
    scale_x_discrete(limits=snps) + 
    theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5), legend.position="right") +
    ggtitle("RATE OG Effect Sizes (interact)") +
    ylim(0,0.9)
...
MCsame <- ggplot() + 
  ...
  scale_x_discrete(limits=snps) + 
  theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5), legend.position="right") +
  ggtitle("RATE MC Effect Sizes (same)")+
  ylim(0,0.9)
...
MCdiff <- ggplot() + 
  ...
  scale_x_discrete(limits=snps) + 
  theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5), legend.position="right") +
  ggtitle("RATE MC Effect Sizes (diff)")+
  ylim(0,0.9)
...
MCoverlap <- ggplot() + 
  ...
  scale_x_discrete(limits=snps) + 
  theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5), legend.position="right") +
  ggtitle("RATE MC Effect Sizes (overlap)")+
  ylim(0,0.9)
...
MCinteract <- ggplot() + 
  ...
  scale_x_discrete(limits=snps) + 
  theme(axis.text.x=element_text(angle=90,hjust=1,vjust=0.5), legend.position="right") +
  ggtitle("RATE MC Effect Sizes (interact)")+
  ylim(0,0.9)
...
#grid.arrange(OGsame, OGdiff, OGoverlap, Quadsame, Quaddiff, Quadoverlap, Quad2same, Quad2diff, Quad2overlap, Combosame, Combodiff, Combooverlap, MCsame, MCdiff, MCoverlap, nrow=5)
```
...
overlap_snps = c(snps[8:9], snps[23:25])
...
#
plot(PP[,2],PP[,1],type = "l",lty = 1, lwd = 3, col = "blue", xlab = "False Positive Rate",ylab = "True Positive Rate", main="Same", ylim = c(0,1),xlim = c(0,1),bty = "n")
...
lines(PP[,14],PP[,13],type = "l",lty = 2, lwd = 3, col = "orange3")
...
m = paste(rate_types," (", format(round(auc,2),digits=2), ") ",sep = "")
#
plot(PP[,2],PP[,1],type = "l",lty = 1, lwd = 3, col = "blue", xlab = "False Positive Rate",ylab = "True Positive Rate", main="Different", ylim = c(0,1),xlim = c(0,1),bty = "n")
lines(PP[,5],PP[,4],type = "l",lty = 4, lwd = 3, col = "magenta")
lines(PP[,8],PP[,7],type = "l",lty = 5, lwd = 3, col = "dark red")
lines(PP[,11],PP[,10],type = "l",lty = 6, lwd = 3, col = "forest green")
lines(PP[,14],PP[,13],type = "l",lty = 2, lwd = 3, col = "orange3")
...
m = paste(rate_types," (", format(round(auc,2),digits=2), ") ",sep = "")
#
plot(PP[,2],PP[,1],type = "l",lty = 1, lwd = 3, col = "blue", xlab = "False Positive Rate",ylab = "True Positive Rate", main = "Overlap", ylim = c(0,1),xlim = c(0,1),bty = "n")
lines(PP[,5],PP[,4],type = "l",lty = 4, lwd = 3, col = "magenta")
lines(PP[,8],PP[,7],type = "l",lty = 5, lwd = 3, col = "dark red")
lines(PP[,11],PP[,10],type = "l",lty = 6, lwd = 3, col = "forest green")
lines(PP[,14],PP[,13],type = "l",lty = 2, lwd = 3, col = "orange3")
...
m = paste(rate_types," (", format(round(auc,2),digits=2), ") ",sep = "")
#
plot(PP[,2],PP[,1],type = "l",lty = 1, lwd = 3, col = "blue", xlab = "False Positive Rate", main="Interact", ylab = "True Positive Rate", ylim = c(0,1),xlim = c(0,1),bty = "n")
lines(PP[,5],PP[,4],type = "l",lty = 4, lwd = 3, col = "magenta")
lines(PP[,8],PP[,7],type = "l",lty = 5, lwd = 3, col = "dark red")
lines(PP[,11],PP[,10],type = "l",lty = 6, lwd = 3, col = "forest green")
lines(PP[,14],PP[,13],type = "l",lty = 2, lwd = 3, col = "orange3")
