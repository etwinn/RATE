...
true_same = t(t(rep(1,10)))%*%true_same
true_diff = t(t(rep(1,10)))%*%true_diff
true_overlap = t(t(rep(1,10)))%*%true_overlap
...
cm=confusionMatrix(true_same, as.vector(same_OG_results), 0)
P[1,1] 
P[1,2]
